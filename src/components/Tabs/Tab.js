...
class Tab extends Component {
  render() {
    ...
    {/* <div className={classNames("react-tabs-tab ",  this.props.active ? "react-tabs-active" : "")} onMouseUp={onClick}> */}
        <div className="react-tabs-tab-content" >{content}</div>
        <div className="react-tabs-tab-close" onMouseUp={onClose}>X</div>
    </div>
    ));
  }
}
